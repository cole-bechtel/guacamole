...
<html lang="en-us">
  <head>
    <meta charset="utf-8">
    <title>1v1.LOL | Symulator Budowy, Bitwa Królewska & Strzelanka</title>
    ...
    <meta property="og:description" content="Poznaj 1v1, wirtualny symulator budowy i strzelankę trzecioosobową. Bitwa królewska, walka budowli, walka skrzyń, wojny strefowe i wiele więcej trybów gry do zabawy!">
    
    <link rel="stylesheet" href="css/style.css">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no">
    <meta name="description"
      content="Poznaj 1v1, wirtualny symulator budowy i strzelankę trzecioosobową. Bitwa królewska, walka budowli, walka skrzyń, wojny strefowe i wiele więcej trybów gry do zabawy!">
